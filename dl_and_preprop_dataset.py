...
parser.add_argument(
    "--dataset", required=True, choices=["ljspeech", "mbspeech"], help="dataset name"
)
        ...
        while True:
            try:
                ...
                for index, row in df.iterrows():
                    ...
                    )  # same format as LJSpeech
                    wav = samples[start:end]
                    wav = librosa.resample(
                        y=wav, orig_sr=sample_rate, target_sr=hp.sr
